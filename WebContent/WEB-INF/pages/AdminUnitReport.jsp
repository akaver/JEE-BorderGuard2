		...
		<div id="forInfoBox" style="display: none;">
			<c:if test="${fn:length(formData.chosenSubordinate.name) > 0}">
				<div
					...
					<br>
					<form:label path="chosenSubordinate.code"><spring:message code="adminUnitReport.label.code" />: ${formData.chosenSubordinate.code}</form:label>
					<br>
					<form:label path="adminUnitTypeName"><spring:message code="adminUnitReport.label.type" />: ${formData.adminUnitTypeName}</form:label>
					<br>
					<form:label path="adminUnitMasterName"><spring:message code="adminUnitReport.label.belongsTo" />: ${formData.adminUnitMasterName}</form:label>
					<br>
