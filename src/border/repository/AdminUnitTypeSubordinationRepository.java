...
public interface AdminUnitTypeSubordinationRepository extends
		JpaRepository<AdminUnitTypeSubordination, Long>, AdminUnitTypeSubordinationRepositoryCustom {
...
//			CONSTRAINT FK1B31BB02F3E6AC82 FOREIGN KEY(SUBORDINATEADMINUNITTYPEID) REFERENCES PUBLIC.ADMINUNITTYPE(ID))
	...
	@Query(value = "select * from AdminUnitTypeSubordination  where SubordinateAdminUnitTypeID=(:adminUnitTypeID) and OpenedDate < NOW() and ClosedDate > NOW() limit 1", nativeQuery = true)
	List<AdminUnitTypeSubordination> getMasterActiveNow(@Param("adminUnitTypeID") Long adminUnitTypeID);
