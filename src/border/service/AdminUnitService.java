...
public class AdminUnitService {
	...
	public void populateData() {
		...
		AdminUnit master = new AdminUnit("Eesti", "Eesti Vabariik", "Kõrgeim haldusüksus, riik", 1L);
...
//		AdminUnit sub12 = new AdminUnit("Karuvere", "Karuvere küla", "", 8L);
		...
		AdminUnitSubordination master_sub1 = new AdminUnitSubordination(master,sub1,"Eesti Vabariik->Harjumaa");
		AdminUnitSubordination sub1_sub11 = new AdminUnitSubordination(sub1,sub11,"Harjumaa->Tallinn");
		AdminUnitSubordination sub1_sub12 = new AdminUnitSubordination(sub1,sub12,"Harjumaa->Kiili vald");
		AdminUnitSubordination sub1_sub13 = new AdminUnitSubordination(sub1,sub13,"Harjumaa->Kure vald");
